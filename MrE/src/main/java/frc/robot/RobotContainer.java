...
public class RobotContainer {
    ...
    public Trajectory m_trajectory = new Trajectory();
    ...
    private RobotContainer() {
        ...
        SmartDashboard.putData("cmdClimbStage2Setpoint: setpointStow",
                new cmdClimbStage2Setpoint(0, m_climbStage2Subsystem));
        SmartDashboard.putData("cmdClimbStage2Setpoint: setpointClimb",
                new cmdClimbStage2Setpoint(500, m_climbStage2Subsystem));
        SmartDashboard.putData("cmdClimbStage2Setpoint: setpointExtend",
                new cmdClimbStage2Setpoint(1000, m_climbStage2Subsystem));
        SmartDashboard.putData("cmdClimbStage2DeploySetpoint: setpointStow",
                new cmdClimbStage2DeploySetpoint(0, m_climbStage2DeploySubsystem));
        SmartDashboard.putData("cmdClimbStage2DeploySetpoint: setpointDeploy",
                new cmdClimbStage2DeploySetpoint(50, m_climbStage2DeploySubsystem));
    ...
    private void configureButtonBindings() {
        ...
        // Create some buttons
        final JoystickButton btnOperatorClimbStage2Setpoint = new JoystickButton(controllerOperator,
        ...
        final JoystickButton btnOperatorClimbStage2DeploySetpoint = new JoystickButton(controllerOperator,
                XboxController.Button.kRightBumper.value);
        btnOperatorClimbStage2DeploySetpoint
                .whenPressed(new cmdClimbStage2DeploySetpoint(0, m_climbStage2DeploySubsystem), true);
        SmartDashboard.putData("btnOperatorClimbStage2DeploySetpoint",
                new cmdClimbStage2DeploySetpoint(0, m_climbStage2DeploySubsystem));
