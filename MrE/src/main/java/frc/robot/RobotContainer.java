...
public class RobotContainer {
        ...
        private void configureButtonBindings() {
                ...
                // final JoystickButton btnShooterSetRPMMin = new
                // JoystickButton(controllerPilot,
                // XboxController.Button.kA.value);
                // btnShooterSetRPMMin.whenPressed(new cmdShooterSetRPM(500,
                // m_shooterSubsystem), true);
                // SmartDashboard.putData("btnShooterSetRPMMin", new cmdShooterSetRPM(50,
                // m_shooterSubsystem));

                // final JoystickButton btnShooterSetRPMMax = new
                // JoystickButton(controllerPilot,
                // XboxController.Button.kY.value);
                // btnShooterSetRPMMax.whenPressed(new cmdShooterSetRPM(1000,
                // m_shooterSubsystem), true);
