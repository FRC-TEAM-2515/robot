...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public ShooterSubsystem() {
        ...
        // m_shooterFollower = new CANSparkMax(ShooterConstants.kShooterFollowerID,
    ...
    public void periodic() {
        ...
        // if((p != ShooterConstants.kP)) { m_pidController.setP(p); ShooterConstants.kP
        // = p; }
        // if((i != ShooterConstants.kI)) { m_pidController.setI(i); ShooterConstants.kI
        // = i; }
        // if((d != ShooterConstants.kD)) { m_pidController.setD(d); ShooterConstants.kD
        // = d; }
        // if((iz != ShooterConstants.kIz)) { m_pidController.setIZone(iz);
        // ShooterConstants.kIz = iz; }
        // if((ff != ShooterConstants.kFF)) { m_pidController.setFF(ff);
        // ShooterConstants.kFF = ff; }
        // if((max != ShooterConstants.kMaxOutput) || (min !=
    ...
    public double getOutputFromVision() {
        ...
        /*
         * Need to do quadratic regression on the stats of output ratio to distance the
         * ball travels,
         * preferably testing 10 times at regular intervals from the minimum output
         * wanted to the maximum output wanted
         */
        /*
         * We need to find the proportion for the percentage output to the distance,
         * basically output divided by the
         * distance would be ko which we could then multiply by distance to get the
         * output we need
         */
        double output;
